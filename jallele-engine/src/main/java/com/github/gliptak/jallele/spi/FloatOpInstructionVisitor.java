...
public class FloatOpInstructionVisitor extends InstructionVisitor {

	protected int[] values={Opcodes.FADD, Opcodes.FDIV, Opcodes.FMUL, Opcodes.FREM, Opcodes.FSUB};

	public FloatOpInstructionVisitor(Random random) {
		super(random);
	}
